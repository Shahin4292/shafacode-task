...
class MusicInfoSection extends StatelessWidget {
  final String title;
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          title,
          style: ralewayBold.copyWith(fontSize: 12, color: Colors.white),
        ),
        ...
        Wrap(
          spacing: 14,
          children: tags.map((tag) => Text("#$tag",
        ...
        Row(
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Row(
                children: [
                  Image.asset(ImagePath.share, height: 20, width: 20),                  const SizedBox(width: 4),
                  Text(
                    "Share",
                    style: ralewaySemiBold.copyWith(
                      fontSize: 12,
